...
map ,,< :vertical resize -20
map ,,> :vertical resize +20
map ,bd :bd 
map ,bb :b 
map ,rc :tabnew ~/.vimrc
map ,sl :mks! ~/dev/ionic-aws/sessions/last.vim
map ,lp :source ~/dev/ionic-aws/sessions/last.vim
...
tabedit ~/dev/ionic-aws/src/app/tab2/tab2content/tab2content.component.html
set splitbelow splitright
set nosplitright
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
